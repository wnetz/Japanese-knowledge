...
def test_config_output_layout():
    ...
    assert c.output.textbook_profile == "auto/textbook_profile.json"
    ...
    assert c.output.grammar_mastery == "manual/grammar_mastery.json"
...
def test_gui_output_layout():
    ...
    assert BUNPRO_PRIMARY_PATH.parts[-2:] == ("auto", "grammar_profile.json")
