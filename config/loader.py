...
def load_config(
    ...
    return AppConfig(
        ...
        output=OutputConfig(
            ...
            grammar_index=          str(output_section.get("grammar_index", "auto/grammar_index.json")),
            textbook_index=         str(output_section.get("textbook_index", "auto/textbook_index.json")),
            grammar_profile=        str(output_section.get("grammar_profile", "auto/grammar_profile.json")),
            grammar_alias_candidates=str(output_section.get("grammar_alias_candidates", "auto/grammar_alias_candidates.json")),
            grammar_use_index=      str(output_section.get("grammar_use_index", "manual/grammar_use_index.json")),
            grammar_aliases=        str(output_section.get("grammar_aliases", "manual/grammar_aliases.json")),
