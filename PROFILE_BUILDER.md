...
`ProfileBuilder` has one responsibility: merge the WaniKani, Anki, and Migaku vocabulary
...
Vocabulary is merged by `(word, reading)`. Matching WaniKani, Anki, and Migaku entries
...
- Migaku has a 100% weight; `KNOWN` scores 1.0 and `LEARNING` scores 0.5.
...
`コーヒー / こーひー`. Genuine alternate readings remain separate.

The final compact study record is:
